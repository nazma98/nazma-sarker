...
import { faDiscord, faFacebook, faGithub, faLinkedin, faTwitter } from '@fortawesome/free-brands-svg-icons';
          ...
          <div className="flex justify-between w-[50%] text-lg m-auto md:w-[30%] lg:w-[18%] text-[#858585]">
            <div>
              <a href="" target="_blank">
                ...
                ></i>
                <FontAwesomeIcon className='rounded-full 
                                ...
                                transition-all duration-300 ease-in-out' icon={ faFacebook } />
              </a>
            </div>
            ...
            <div>
              <a href="mailto:nazma.sarker1398@gmail.com">
                <FontAwesomeIcon className='rounded-full 
                                ...
                                transition-all duration-300 ease-in-out' icon={ faEnvelope} />
              </a>
            </div>
            ...
            <div>
              <a href="" target="_blank">
                <FontAwesomeIcon className='rounded-full 
                                ...
                                transition-all duration-300 ease-in-out' icon={ faTwitter} />
              </a>
            </div>
            <div>
              <a
              ...
              >
                <FontAwesomeIcon className='rounded-full 
                                ...
                                transition-all duration-300 ease-in-out' icon={ faLinkedin } />
              </a>
            </div>
            <div>
              <a href="https://github.com/nazma98" target="_blank">
                <FontAwesomeIcon className='rounded-full 
                                ...
                                transition-all duration-300 ease-in-out' icon={faGithub} />
              </a>
            </div>
            <div>
              <a href="https://discord.com/users/nazma9029" target="_blank">
                <FontAwesomeIcon className='rounded-full 
                                ...
                                transition-all duration-300 ease-in-out' icon={faDiscord} />
              </a>
            </div>
          </div>
          <div
